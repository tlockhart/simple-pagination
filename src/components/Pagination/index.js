 ...
 ** tableHeaders: Header array,
 ** table fields: Table fieldNames
 ...
 ** recommendedPageLimit: The number of pages to be shown in the pagination. In our case, it will be 5 pages at a time.
 */
